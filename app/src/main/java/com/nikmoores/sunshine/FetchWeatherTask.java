...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        // change this option without us having to re-fetch the data once7u`ywtSWZ
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        Long locationId;
        // Check if location exists (if it does, then return the current ID).
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            // Uncomment the next lines to display what what was stored in the bulkInsert
